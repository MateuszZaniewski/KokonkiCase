...
export default function ObserverInsta() {
  return (
    <>
      <div className="text-[#222220] xl:px-[122px] xl:pb-10 hidden xl:flex">
      ...
      <div className="xl:hidden h-72 w-auto text-white text-center my-10 px-4 md:w-[550px] lg:w-[700px] mx-auto">
        <div className="h-full w-full">
          <div className="bg-[url('./assets/sweater.svg')] bg-cover bg-no-repeat bg-center h-full w-full flex flex-col items-center justify-center rounded-md">
